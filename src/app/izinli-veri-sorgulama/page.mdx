...
<Row>
  ...
  ### Endpoint URL
    <RequestAddress method="POST" url="https://api.dijiizin.com/api/V3/person/{uuid}" />
...
### Authorization
 ...
 <Table data={[
  ...
  <Col sticky>
    ...
    ```json {{ 'title': 'Örnek Request','tag':'POST','label':'https://api.dijiizin.com/api/V3/person/{uuid}' }}
       ```
    <CodeGroup  title="Örnek Response" >
